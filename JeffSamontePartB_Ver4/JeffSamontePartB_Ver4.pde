...
void setup() {
  size(800, 600);
  star1 = new Stars("imgbin-logo-star-the-left-star-qC7Nb3NjuaFFQNmasvsa0w1in_t-removebg-preview.png", 10, 10, 2, 35, 35); 
  star2 = new Stars("imgbin-logo-star-the-left-star-qC7Nb3NjuaFFQNmasvsa0w1in_t-removebg-preview.png", 50, 150, 3, 35, 35); 
  ...
  shuttle1 = new Shuttle(200, 600,4, 200, 100);
